...
export interface WorkspaceLedgerItem {
    ...
    /**
     * 
     * @type {WorkspaceLedgerItemAlerts}
     * @memberof WorkspaceLedgerItem
     */
    'alerts'?: WorkspaceLedgerItemAlerts;
    /**
     * 
     * @type {WorkspaceLedgerItemGoals}
     * @memberof WorkspaceLedgerItem
     */
    'goals'?: WorkspaceLedgerItemGoals;
}
/**
 * 閾値にかかった場合、アラート通知をオンにしているユーザーに通知します。
 * @export
 * @interface WorkspaceLedgerItemAlert
 */
export interface WorkspaceLedgerItemAlert {
    /**
     * 
     * @type {number}
     * @memberof WorkspaceLedgerItemAlert
     */
    'threshold'?: number;
    /**
     * 
     * @type {WorkspaceLedgerItemAlertType}
     * @memberof WorkspaceLedgerItemAlert
     */
    'type'?: WorkspaceLedgerItemAlertType;
}
...
export const WorkspaceLedgerItemAlertType = {
    More: 'More',
    Less: 'Less'
} as const;

export type WorkspaceLedgerItemAlertType = typeof WorkspaceLedgerItemAlertType[keyof typeof WorkspaceLedgerItemAlertType];


/**
 * 
 * @export
 * @interface WorkspaceLedgerItemAlerts
 */
export interface WorkspaceLedgerItemAlerts extends Array<WorkspaceLedgerItemAlert> {
}
/**
 * 
 * @export
 * @interface WorkspaceLedgerItemGoals
 */
export interface WorkspaceLedgerItemGoals extends Array<WorkspaceLedgerItemAlert> {
}
/**
 * 
 * @export
