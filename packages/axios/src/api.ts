...
export const WorkspaceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        findMemberSecuritySetting_4: async (workspaceId: string, workspaceLedgerId: string, memberId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'workspaceId' is not null or undefined
            ...
            // verify required parameter 'memberId' is not null or undefined
            assertParamExists('findMemberSecuritySetting_4', 'memberId', memberId)
         ...
         * @throws {RequiredError}
         */
        updateMemberSecuritySetting_7: async (workspaceId: string, workspaceLedgerId: string, memberId: string, workspaceLedgerMemberSecuritySettings?: WorkspaceLedgerMemberSecuritySettings, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'workspaceId' is not null or undefined
            ...
            // verify required parameter 'memberId' is not null or undefined
            assertParamExists('updateMemberSecuritySetting_7', 'memberId', memberId)
            const localVarPath = `/workspaces/[workspaceId]/ledgers/[workspaceLedgerId]/members/[workspaceLedgerMemberId]security-settings`
                .replace(`{${"workspaceId"}}`, encodeURIComponent(String(workspaceId)))
                .replace(`{${"workspaceLedgerId"}}`, encodeURIComponent(String(workspaceLedgerId)))
                .replace(`{${"memberId"}}`, encodeURIComponent(String(memberId)));
...
export const WorkspaceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async findMemberSecuritySetting_4(workspaceId: string, workspaceLedgerId: string, memberId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WorkspaceLedgerMemberSecuritySettings>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.findMemberSecuritySetting_4(workspaceId, workspaceLedgerId, memberId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * IDを使用してワークスペースのセキュリティ設定を取得します。
         ...
         * @throws {RequiredError}
         */
        async updateMemberSecuritySetting_7(workspaceId: string, workspaceLedgerId: string, memberId: string, workspaceLedgerMemberSecuritySettings?: WorkspaceLedgerMemberSecuritySettings, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateMemberSecuritySetting_7(workspaceId, workspaceLedgerId, memberId, workspaceLedgerMemberSecuritySettings, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * IDを使用してワークスペースのセキュリティ設定を更新します。
...
export const WorkspaceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        findMemberSecuritySetting_4(workspaceId: string, workspaceLedgerId: string, memberId: string, options?: any): AxiosPromise<WorkspaceLedgerMemberSecuritySettings> {
            return localVarFp.findMemberSecuritySetting_4(workspaceId, workspaceLedgerId, memberId, options).then((request) => request(axios, basePath));
        },
        /**
         * IDを使用してワークスペースのセキュリティ設定を取得します。
         * @summary ワークスペースのセキュリティ設定の取得を行います。
         ...
         * @throws {RequiredError}
         */
        updateMemberSecuritySetting_7(workspaceId: string, workspaceLedgerId: string, memberId: string, workspaceLedgerMemberSecuritySettings?: WorkspaceLedgerMemberSecuritySettings, options?: any): AxiosPromise<void> {
            return localVarFp.updateMemberSecuritySetting_7(workspaceId, workspaceLedgerId, memberId, workspaceLedgerMemberSecuritySettings, options).then((request) => request(axios, basePath));
        },
        /**
         * IDを使用してワークスペースのセキュリティ設定を更新します。
         * @summary ワークスペースのセキュリティ設定の更新を行います。
...
export interface WorkspaceApiInterface {
     ...
     * @memberof WorkspaceApiInterface
     */
    findMemberSecuritySetting_4(workspaceId: string, workspaceLedgerId: string, memberId: string, options?: AxiosRequestConfig): AxiosPromise<WorkspaceLedgerMemberSecuritySettings>;
     ...
     * @memberof WorkspaceApiInterface
     */
    updateMemberSecuritySetting_7(workspaceId: string, workspaceLedgerId: string, memberId: string, workspaceLedgerMemberSecuritySettings?: WorkspaceLedgerMemberSecuritySettings, options?: AxiosRequestConfig): AxiosPromise<void>;
...
export class WorkspaceApi extends BaseAPI implements WorkspaceApiInterface {
     ...
     * @memberof WorkspaceApi
     */
    public findMemberSecuritySetting_4(workspaceId: string, workspaceLedgerId: string, memberId: string, options?: AxiosRequestConfig) {
        return WorkspaceApiFp(this.configuration).findMemberSecuritySetting_4(workspaceId, workspaceLedgerId, memberId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof WorkspaceApi
     */
    public updateMemberSecuritySetting_7(workspaceId: string, workspaceLedgerId: string, memberId: string, workspaceLedgerMemberSecuritySettings?: WorkspaceLedgerMemberSecuritySettings, options?: AxiosRequestConfig) {
        return WorkspaceApiFp(this.configuration).updateMemberSecuritySetting_7(workspaceId, workspaceLedgerId, memberId, workspaceLedgerMemberSecuritySettings, options).then((request) => request(this.axios, this.basePath));
    }
